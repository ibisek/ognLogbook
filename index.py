...
def findFlights():
    ...
    flights = listFlights(icaoCode=loc, forDay=date, display_tz=_getBrowserTimezone(), limit=128)   # TODO toto chce nejake fikanejsi a elegantnejsi hledani
...
def listEncounters(flightId: int):
    ...
    encounters: list[Encounter] = listEncountersWithRegistration(flightId=flightId)
